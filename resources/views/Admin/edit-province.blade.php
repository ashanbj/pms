                    ...
                    <table class="mdl-data-table table-responsive-xl" id="datatable">
                        ...
                        <tbody>
                            ...
                            @foreach ($province as $item)
                                <tr>
                                    <td scope="row">{{$item->pro_no}}</td>
                                    <td>{{$item->pro_name}}</td>
                                    <td>
                                        <div class="btns-group justify-content-center">
                                            <button id="edit-btn" name="edit-btn" type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit-data" data-id='{{$item->id}}' data-name='{{$item->pro_name}}' data-no='{{$item->pro_no}}'>
                                                Edit
                                            </button>
                            ...
                            <div class="modal fade" id="edit-data" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="/edit-province-data" method="POST">
                                    @csrf
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edit Provice Data</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-area">
                                                    <div class="form-group">
                                                        <label for="category_no">Province No :</label>
                                                        <input type="number" class="form-control" name="pro_no" id="pro_no1">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pro_name">Province Name :</label>
                                                        <input type="text" class="form-control" name="pro_name" id="pro_name1">
                                                    </div>
                                                </div>
                                            </div>
